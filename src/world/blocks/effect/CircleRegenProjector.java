...
public class CircleRegenProjector extends Block{
    ...
    public CircleRegenProjector(String name){
        super(name);
        solid = true;
        update = true;
    ...
    public void drawPlace(int x, int y, int rotation, boolean valid){
        ...
        Drawf.dashCircle(x * tilesize + offset, y * tilesize + offset, range * tilesize, baseColor);

        indexer.eachBlock(player.team(), x * tilesize + offset, y * tilesize + offset, range * tilesize, other -> true, other -> Drawf.selected(other, Tmp.c1.set(baseColor).a(Mathf.absin(4f, 1f))));
    }
    ...
    public void setStats(){
        ...
        if(findConsumer(c -> c instanceof ConsumeItems) instanceof ConsumeItems cons && cons.booster){
    ...
    public class RegenProjectorBuild extends Building{
        ...
        public void updateTargets(){
            targets.clear();
            taken.clear();
            indexer.eachBlock(this, range * tilesize, other -> true, targets::add);
        }
        ...
        public void drawSelect(){
            indexer.eachBlock(this, range * tilesize, other -> true, other -> Drawf.selected(other, Tmp.c1.set(baseColor).a(Mathf.absin(4f, 1f))));

            Drawf.dashCircle(x, y, range * tilesize, baseColor);
        }
